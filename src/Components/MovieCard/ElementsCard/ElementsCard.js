...
import ElementsGenres from '../ElementsGenres/ElementsGenres'

const ElementsCard = ({ el, postRated, img, Genres }) => {
  ...
  return (
    <div className={Style.MovieCard}>
      {load ? (
        ...
        <div className={Style.MovieCard__picture}>
          <Spin tip="Loading" size="large">
            <div className="content" style={{ height: '282px' }} />
          </Spin>
        </div>
      )}
      <img
      ...
      <div className={Style.MovieCard__infoBlock}>
        ...
        <div className={Style.MovieCard__genreList}>{<ElementsGenres el={el} Genres={Genres} />}</div>
